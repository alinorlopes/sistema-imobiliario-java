...
public abstract class Financiamento implements Serializable {
    ...
    public double getPagamentoMensal() { return this.pagamentoMensal; }
    public double getTotalPagamento() { return this.totalPagamento; }
    ...
    public String toString() {
        if (totalPagamento == 0) calcularPagamentoTotal();
    ...
    public double calcularPagamentoTotal() {
        if (pagamentoMensal == 0) calcularPagamentoMensal();
        totalPagamento = pagamentoMensal * prazoFinanciamento * 12;
        return totalPagamento;
    }

    // Método abstrato -> cada subclasse vai implementar
    public abstract void exibirDetalhes();

    // Método para salvar no arquivo de texto
    public String toTexto() {
        return id + ";" + valorImovel + ";" + prazoFinanciamento + ";" + taxaJurosAnual;
    }
}
